...
$pdf->Write(10,$LVH);
$pdf->Write(10,"MM)");
$pdf->Cell(0,10,"RIGHT Ventricle is normal size",0,0,'R');
...
$pdf->Cell(0,10,"RIGHT Atrial is normal size",0,0,'R');
$pdf->Write(10,"Diastolic Dysfunction is ");
$pdf->Write(10,$DD);
$pdf->SetTextColor(255,0,0);
$pdf->SetFont('Times','B',14);
$pdf->Write(10,"\n");
$pdf->Cell(40,10,"TAPSE:".$TAPSE,0,0,'L');
...
$pdf->Write(10,$EF_str." LV SYSTOLIC DYSFUNCTION & SIZE. "."LV = ".$EF." . ".$DD." DD.");
$pdf->Write(10,"\n".$RV." RV SYSTOLIC FUNCTION & SIZE.\n");
$pdf->Write(10,$MR." MR. ".$AI." AI. ".$PI." PI. ".$TR." TR. "."PAPs : ".$PAP." MMHG.\n");
